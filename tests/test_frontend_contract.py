...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_public_homepage_is_user_prediction_page_not_ops_console(self):
        ...
        self.assertIn("模型公平概率", home_source)
        self.assertIn("市场价格源待接入", home_source)
        self.assertIn("今日可讲选题", home_source)
        self.assertIn("比分矩阵", home_source)
        self.assertIn("进球市场视角", home_source)
